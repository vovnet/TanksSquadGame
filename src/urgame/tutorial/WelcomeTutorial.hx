 ...
 * @author Vladimir
 */
class WelcomeTutorial extends Component {
	...
	public function new(manager:TutorialManager) {
		...
		text = new ImageSprite(G.pack.getTexture("tutorials/welcome_text"));
		text.centerAnchor();
		text.setXY(268, 110);
